...
# If LOG_GROUP_ID is None, assign a default value
if LOG_GROUP_ID is None:
    LOG_GROUP_ID = -1001234567890  # Default group ID
else:
    LOG_GROUP_ID = int(LOG_GROUP_ID)

LOGGER_ID = getenv("LOGGER_ID", None)

# If LOGGER_ID is None, assign a default value
if LOGGER_ID is None:
    LOGGER_ID = -1001234567890  # Default group ID
else:
